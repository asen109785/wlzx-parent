...
public enum CourseCode implements ExceptionResult {
    ...
    COURSE_GET_NOTEXISTS(false,31107,"选择的课程不存在！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31108,"允许选择第三级的课程计划关联视频！"),
    COURSE_PIC_EXISTS(false,31109,"课程图片已经存在！"),
    COURSE_MEDIA_NOTEXISTS(false,31110,"媒资不存在");
    //操作代码
